...
public class CPoolProxy implements ManagedHttpClientConnection, HttpContext {
    ...
    private long connectElapseMillisecond;
    ...
    public InetAddress getRemoteAddress() {
        ...
        if(remoteAddress == null){
            HttpRoute route = this.poolEntry.getRoute();
            HttpHost targetHost = route.getTargetHost();
            return targetHost.getAddress();
        }
    ...
    public void setConnectElapseMillisecond(long connectElapseMillisecond) {
        this.connectElapseMillisecond = connectElapseMillisecond;
    }

    public long getConnectElapseMillisecond() {
        return this.connectElapseMillisecond;
    }
}
