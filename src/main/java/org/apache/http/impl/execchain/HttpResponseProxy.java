...
class HttpResponseProxy implements CloseableHttpResponse {
    ...
    public String getRemoteAddress() {
        return this.connHolder.getRemoteAddress();
    }

    @Override
    public long getConnectElapseMillisecond() {
        return this.connHolder.getConnectElapseMillisecond();
    }

    @Override
    public long getResponseElapseMillisecond() {
        return ((BasicHttpResponse)original).getResponseElapseMillisecond();
    }
}
